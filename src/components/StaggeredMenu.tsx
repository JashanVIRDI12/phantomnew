  ...
  return (
    ...
    >
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors.slice(0, 4) : ['#e10600', '#1a1a1d'];
          let arr = [...raw];
          if (arr.length >= 3) {
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
        <div className="sm-panel-inner">
          ...
          {/* Mobile-only bottom CTA — calls dispatch */}
          <div className="sm-cta-block" aria-hidden="false">
            <a href="/contact" className="sm-cta-dispatch" onClick={closeMenu}>
              Get a Free Quote →
            </a>
          </div>
        </div>
