...
const EQUIPMENT = [
  "GOOSENECK + FLATBED + ENCLOSED UNITS",
  "SIZED FOR 1–8 PALLETS OR PROJECT LOADS",
  "SAME-DAY / NEXT-MORNING PICKUP",
  "GPS + ELD, EVERY UNIT",
  "DIRECT DRIVER CONTACT — NO CALL CENTER",
...
const FREIGHT_TYPES = [
  ...
  "OILFIELD EQUIPMENT",
  "EVENT & TRADE SHOW FREIGHT",
  "URGENT MANUFACTURING RUNS",
  "SMALL / PROJECT LOADS",
];
...
const GUARANTEES = [
  { n: "01", v: "68 MIN", k: "Average Dispatch Time", d: "from call to a truck assigned — not a next-business-day callback." },
  { n: "02", v: "4.9/5", k: "Customer NPS", d: "measured on every hotshot load, not just the easy ones." },
  { n: "03", v: "310", k: "Hotshot Loads Last Quarter", d: "real, active volume — not a side capability we rarely run." },
  { n: "04", v: "DIRECT", k: "Driver Contact", d: "you talk to the driver moving your freight, not a call center." },
];

const FAQS = [
  {
    q: "What size loads do you actually run?",
    a: "1 to 8 pallets or project-style freight — small enough that a full 53' van doesn't make sense.",
  },
  {
    q: "How fast can you dispatch a hotshot load?",
    a: "68 minutes average from call to truck assigned — real humans answer, we move fast.",
  },
  {
    q: "What kind of equipment do you run for hotshot?",
    a: "Goosenecks, flatbeds, and enclosed sprinter-style units, matched to the load.",
  },
  {
    q: "Can I talk directly to the driver?",
    a: "Yes — direct driver communication is standard on hotshot, no call center in between.",
  },
  {
    q: "Do you handle odd or awkward freight?",
    a: "That's most of what hotshot is — if it doesn't fit a normal load, it's exactly what we're built for.",
  },
];
        ...
        <div className="svl-wrap">
          ...
          >
            <div className="svl-hero-row">
              <div className="svl-hero-col">
                ...
                <p className="svl-positioning" data-svl-fade>
                  Small loads, real urgency — gooseneck, flatbed, and enclosed units dispatched at a moment&apos;s notice.
                </p>
              ...
              <div className="svl-photo-col" data-svl-fade>
                <div className="svl-photo-frame">
                  ...
                  <img src={service.img} alt="Phantom Logistics hotshot unit on an active lane" />
                </div>
                <div className="svl-visual-caption">Direct dispatch — rapid response</div>
              </div>
            </div>
            ...
            <div className="svl-block svl-specs-block">
              <h2 className="svl-block-title">What&apos;s on every hotshot dispatch</h2>
              ...
              <div className="svl-photo-band">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={service.img} alt="Phantom Logistics hotshot unit running a lane" />
                <div className="svl-photo-band-inner">
                  <div className="svl-photo-band-title">Small load. Big urgency. Same standards.</div>
                  <div className="svl-photo-band-facts">
                    <span>68 MIN AVG DISPATCH</span>
                    <span>310 LOADS LAST QUARTER</span>
                    <span>4.9/5 CUSTOMER NPS</span>
                    <span>DIRECT DRIVER CONTACT</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="svl-block">
              <h2 className="svl-block-title">How a hotshot load moves</h2>
              ...
              <div className="svl-drivers">
                ...
                <div className="svl-drivers-copy">
                  <p className="svl-drivers-fade">
                    Every hotshot run on this page is a dedicated Phantom driver — not a side hustle, not a broker&apos;s best guess. Same
                    paperwork and reliability standards as our biggest loads.
                  </p>
          ...
          <div className="svl-cta-photo">
            ...
            <div className="svl-cta-photo-inner">
              <h2>Need a hotshot load moved now?</h2>
              <p>Call dispatch directly. We&apos;ll match the right truck and get it rolling the same day.</p>
